  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-20">
        <ProductItem image="/Screenshot 2024-09-05 at 10.24.12 PM.png" name="Bed Side Table" {...findCategoryAndSubcategory("BedsideTable")} />
        <ProductItem image="/Screenshot 2024-09-05 at 10.24.18 PM.png" name="Wardrobe" {...findCategoryAndSubcategory("Wardrobe")} />
